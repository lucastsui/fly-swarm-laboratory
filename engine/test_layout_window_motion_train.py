...
import torch
from .layout_window_motion_train import window_outputs, active_rows, attempt, guarded_attempt, validate_rejection
...
MODULE = 'engine.layout_window_motion_train.'
...
class PriorEvidenceTests(unittest.TestCase):
    def docs(self):
        ...
        return {'manifest':{'parentParameterHash':'parent'},'initial-all-window-measure':before,'provisional-step':proposal,
                ...
                'result':{'algorithm':'one-pooled-box-update-with-candidate-full-history-gate-v1','acceptedUpdates':0,
